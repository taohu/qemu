                                  ...
                                  qemu_irq *pic)
{
    ...
    memory_region_init_ram_nofail(ram, NULL, "vexpress.highmem", ram_size);
                                   ...
                                   qemu_irq *pic)
{
    ...
    memory_region_init_ram_nofail(sram, NULL, "vexpress.a15sram", 0x10000);
                                 ...
                                 MachineState *machine)
{
    ...
    sram_size = 0x2000000;
    memory_region_init_ram_nofail(sram, NULL, "vexpress.sram", sram_size);
    vmstate_register_ram_global(sram);
    memory_region_add_subregion(sysmem, map[VE_SRAM], sram);

    vram_size = 0x800000;
    memory_region_init_ram_nofail(vram, NULL, "vexpress.vram", vram_size);
