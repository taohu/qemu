                         ...
                         unsigned int sdram_size, const char *revision)
{
    ...
    memory_region_init_ram_nofail(&s->sdram, NULL, "pxa270.sdram", sdram_size);
    vmstate_register_ram_global(&s->sdram);
    memory_region_add_subregion(address_space, PXA2XX_SDRAM_BASE, &s->sdram);
    memory_region_init_ram_nofail(&s->internal, NULL, "pxa270.internal", 0x40000);
...
PXA2xxState *pxa255_init(MemoryRegion *address_space, unsigned int sdram_size)
{
    ...
    /* SDRAM & Internal Memory Storage */
    memory_region_init_ram_nofail(&s->sdram, NULL, "pxa255.sdram", sdram_size);
    vmstate_register_ram_global(&s->sdram);
    memory_region_add_subregion(address_space, PXA2XX_SDRAM_BASE, &s->sdram);
    memory_region_init_ram_nofail(&s->internal, NULL, "pxa255.internal",
