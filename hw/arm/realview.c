                          ...
                          enum realview_board_type board_type)
{
    ...
    if (is_pb && ram_size > 0x20000000) {
        ...
        ram_size = 0x20000000;
        memory_region_init_ram_nofail(ram_lo, NULL, "realview.lowmem", low_ram_size);
        vmstate_register_ram_global(ram_lo);
        memory_region_add_subregion(sysmem, 0x20000000, ram_lo);
    }

    memory_region_init_ram_nofail(ram_hi, NULL, "realview.highmem", ram_size);
    ...
    memory_region_init_ram_nofail(ram_hack, NULL, "realview.hack", 0x1000);
