...
static int qxl_init_common(PCIQXLDevice *qxl)
{
    ...
    memory_region_init_ram_nofail(&qxl->rom_bar, OBJECT(qxl), "qxl.vrom",
                           qxl->rom_size);
    ...
    memory_region_init_ram_nofail(&qxl->vram_bar, OBJECT(qxl), "qxl.vram",
                           qxl->vram_size);
...
static int qxl_init_secondary(PCIDevice *dev)
{
    ...
    qxl->id = device_id++;
    qxl_init_ramsize(qxl);
    memory_region_init_ram_nofail(&qxl->vga.vram, OBJECT(dev), "qxl.vgavram",
                           qxl->vga.vram_size);
